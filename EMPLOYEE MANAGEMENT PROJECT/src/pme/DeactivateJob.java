...
public class DeactivateJob implements ActionListener{
    JFrame f;
    JTextField t;
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==b1){
            try{
                DbConnection con = new DbConnection();
                String str = "UPDATE  project1.employee SET JobStatus = 'Deactive' where EmployeeID = '"+t.getText()+"'";
                ...
                JOptionPane.showMessageDialog(null,"Exception Occured While Deactivting Record "+ex);
            }
        }
        if(ae.getSource()==b2){
            f.setVisible(false);

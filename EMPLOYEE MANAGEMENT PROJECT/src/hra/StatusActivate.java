...
public class StatusActivate implements ActionListener{
    JFrame f;
    JTextField t;
    ...
    StatusActivate(){
        f=new JFrame("ACTIVATE EMPLOYEE");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==b){
            try{
                ...
                String str = "select EmployeeID,FirstName,Status from project1.employee where EmployeeID ='"+t.getText()+"' ";
        ...
        if(ae.getSource()==b1){
            try{
                DbConnection con = new DbConnection();
                String str = "UPDATE  project1.employee SET Status = 'Active' where EmployeeID = '"+t.getText()+"'";
